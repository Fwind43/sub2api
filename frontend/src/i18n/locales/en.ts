export default {
  ...
  nav: {
    ...
    apiKeys: 'API Keys',
    modelPlayground: 'Image Playground',
    usage: 'Usage',
    redeem: 'Redeem',
  ...
  modelPlayground: {
    ...
    description: 'Test Images API and the Responses image tool inside the platform with a layout inspired by gpt_image_playground.',
    historyNote: 'Image tasks and results are saved locally in this browser per signed-in user; real requests still create normal platform usage and billing records.',
    connection: 'Connection',
    apiKey: 'API Key',
    selectApiKey: 'Select API key',
    pasteApiKey: 'Paste API key manually',
    manualApiKey: 'Manual API key',
    backendProxy: 'Requests go through the backend proxy and keep normal gateway usage and billing records.',
    settingsTitle: 'Playground settings',
    searchPlaceholder: 'Search prompts, models, or params',
    favorites: 'Favorites',
    exportData: 'Export',
    importData: 'Import',
    clearAll: 'Clear all',
    clearAllConfirm: 'Clear local playground tasks and images in this browser?',
    noMatchedTasks: 'No matching generation records.',
    taskDetail: 'Task detail',
    reuse: 'Reuse',
    reused: 'Configuration reused in the input bar',
    outputsAdded: 'Output images added as references',
    imported: 'Data imported',
    deleteTask: 'Delete record',
    deleteTaskConfirm: 'Delete this record?',
    ...
    systemPlaceholder: 'Optional. Set role, tone, or constraints for the model.',
    size: 'Size',
    quality: 'Quality',
    ...
    codexCli: 'Codex CLI compatible mode',
    codexCliHint: 'Keep the exact prompt and omit non-auto quality parameters.',
    chatConsole: 'Chat console',
    chatHint: 'Keep context across turns and call /v1/chat/completions.',
    imageConsole: 'Image generation',
    imageHint: 'Supports Images API generation/editing and the Responses API image_generation tool.',
    clear: 'Clear',
    emptyChat: 'Send a message to start testing.',
    emptyImage: 'Write an image prompt to generate a result.',
    you: 'You',
    assistant: 'Model',
    userPromptPlaceholder: 'Type a message. Ctrl/⌘ + Enter to send.',
    shortcut: 'Shortcut: Ctrl/⌘ + Enter',
    send: 'Send',
    running: 'Running...',
    imagePrompt: 'Image prompt',
    imagePromptPlaceholder: 'Describe the subject, style, composition, and details.',
    referenceImages: 'Reference images',
    referenceImagesHint: 'Uploading references automatically sends an image edit request. Up to 16 images.',
    addImages: 'Add images',
    editAgain: 'Use as reference',
    generate: 'Generate image',
    generating: 'Generating...',
    download: 'Download image',
    rawResponse: 'Raw response',
    errors: {
      missingApiKey: 'Select or paste an API key first',
      missingEndpoint: 'Enter an endpoint',
      missingPrompt: 'Enter a prompt first',
      requestFailed: 'Request failed',
      noImage: 'The API returned data, but no image could be parsed',
      referenceNeedsDataUrl: 'Only Base64 image results can be reused as reference images directly'
    }
  },
