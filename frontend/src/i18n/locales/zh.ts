export default {
  ...
  modelPlayground: {
    badge: '实时验证',
    title: '图片试炼场',
    description: '参考 gpt_image_playground 的前端布局，在平台内快速验证 Images API 与 Responses 图片工具的请求、响应和原始返回。',
    historyNote: '图片任务和结果会按登录用户保存在当前浏览器本地；实际请求仍会进入平台用量记录和计费。',
    connection: '连接配置',
    apiKey: 'API Key',
    selectApiKey: '选择 API Key',
    pasteApiKey: '手动粘贴 API Key',
    manualApiKey: '手动 API Key',
    backendProxy: '请求走后端代理，自动进入平台网关、用量记录和计费链路。',
    settingsTitle: '试炼场设置',
    searchPlaceholder: '搜索提示词、模型或参数',
    favorites: '收藏',
    exportData: '导出',
    importData: '导入',
    clearAll: '清空全部',
    clearAllConfirm: '确定清空图片试炼场的本地任务和图片记录吗？此操作只影响当前浏览器。',
    noMatchedTasks: '没有找到匹配的生成记录。',
    taskDetail: '任务详情',
    reuse: '复用',
    reused: '已复用配置到输入框',
    outputsAdded: '已添加输出图到参考图',
    imported: '数据已导入',
    deleteTask: '删除记录',
    deleteTaskConfirm: '确定要删除这条记录吗？',
    statusRunning: '运行中',
    statusDone: '完成',
    statusError: '失败',
    modelParams: '模型参数',
    ...
    maxTokens: '最大 Token',
    systemPrompt: '系统提示词',
    systemPlaceholder: '可选。给模型设置角色、风格或约束。',
    size: '尺寸',
    quality: '质量',
    responseFormat: '返回格式',
    outputFormat: '输出格式',
    compression: '压缩质量',
    moderation: '审核',
    codexCli: 'Codex CLI 兼容模式',
    codexCliHint: '保持原始提示词、不改写；质量参数固定为 auto。',
    chatConsole: 'Chat 控制台',
    chatHint: '保留上下文连续对话，使用 /v1/chat/completions。',
    imageConsole: '图片生成',
    imageHint: '支持 Images API 生成/编辑与 Responses API image_generation 工具。',
    clear: '清空',
    emptyChat: '输入一条消息开始试炼。',
    emptyImage: '填写图片提示词后开始生成。',
    you: '你',
    assistant: '模型',
    userPromptPlaceholder: '输入消息，Ctrl/⌘ + Enter 发送',
    shortcut: '快捷键：Ctrl/⌘ + Enter',
    send: '发送',
    running: '请求中...',
    imagePrompt: '图片提示词',
    imagePromptPlaceholder: '描述你想生成的画面、风格、构图和细节。',
    referenceImages: '参考图片',
    referenceImagesHint: '上传参考图后将自动切换为图片编辑请求，最多 16 张。',
    addImages: '添加图片',
    editAgain: '作为参考',
    generate: '生成图片',
    generating: '生成中...',
    ...
    rawResponse: '原始响应',
    errors: {
      missingApiKey: '请先选择或粘贴 API Key',
      missingEndpoint: '请填写接口地址',
      missingPrompt: '请输入提示词',
      requestFailed: '请求失败',
      noImage: '接口已返回，但未解析到图片',
      referenceNeedsDataUrl: '只有 Base64 图片结果可以直接作为参考图继续编辑'
    }
  },
